...
namespace JobPortal2.Migrations
{
    ...
    [Migration("20190921144240_newOne")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("JobPortal__.Data.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("JobPortal__.Data.ApplicationUser", b =>
                {
                    b.HasOne("JobPortal2.Model.Employee", "Employee")
                        .WithMany()
                        .HasForeignKey("EmployeeId");

                    b.HasOne("JobPortal2.Model.Employer", "Employer")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("JobPortal__.Data.ApplicationUser")
                        .WithMany()
